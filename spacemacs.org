...
* Spacemacs Init File
:PROPERTIES:
:header-args: :tangle .dist/src/.spacemacs.d/init.el :mkdirp yes
:END:
...
#+BEGIN_SRC text :tangle .dist/src/.emacs.d/templates/note.txt :mkdirp yes
       ,* %^{description}
       :LOGBOOK:
       - Added: %U
       :END:
...
#+BEGIN_SRC text :tangle .dist/src/.emacs.d/templates/todo.txt :mkdirp yes
       ,* TODO %?
       :LOGBOOK:
       - Added: %U
       :END:
...
#+BEGIN_SRC text :tangle .dist/src/.emacs.d/templates/link.txt :mkdirp yes
       ,* %?
       :LOGBOOK:
       - Added: %U
       :END:
...
*** layers
The =layers.el= file.
#+BEGIN_SRC emacs-lisp :tangle .dist/src/.spacemacs.d/layers/config/layers.el :mkdirp yes
...
*** packages
:PROPERTIES:
:header-args: :tangle .dist/src/.spacemacs.d/layers/config/packages.el :mkdirp yes
:END:
...
*** config
the =config.el= file.
#+BEGIN_SRC emacs-lisp :tangle .dist/src/.spacemacs.d/layers/config/config.el :mkdirp yes
  (defvar x/org-publish-root "~/publish")
#+END_SRC
*** funcs
:PROPERTIES:
:header-args: :tangle .dist/src/.spacemacs.d/layers/config/funcs.el :mkdirp yes
:END:
...
*** keybindings
:PROPERTIES:
:header-args: :tangle .dist/src/.spacemacs.d/layers/config/keybindings.el :mkdirp yes
:END:
...
#+BEGIN_SRC conf :tangle .dist/src/.spacemacs.d/.link_folder :mkdirp yes
link the whole folder
#+END_SRC

#+BEGIN_SRC conf :tangle .dist/src/.emacs.d/templates/.link_folder :mkdirp yes
link the whole folder
#+END_SRC
