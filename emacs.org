#+SETUPFILE: .setup
#+TITLE: Emacs
#+DESCRIPTION: My old emacs setup. I am using spacemacs now.

#+BEGIN_PREVIEW
This was my emacs setup without spacemacs. I have switched back to spacemacs
(taking of the community as much as I can), this setup is deprecated. You can
find my current setup [[file:spacemacs.org][here]].
#+END_PREVIEW
...
Cleanup white spaces and save buffer.
#+BEGIN_SRC emacs-lisp
...
Recompile elpa. This will solve the [[https://github.com/syl20bnr/spacemacs/issues/7641][Evaluation of this sh code block is disabled]] issue.
#+BEGIN_SRC emacs-lisp
...
** settings and behaviors
    :LOGBOOK:
    CLOCK: [2017-07-22 Sat 14:57]--[2017-07-22 Sat 15:36] =>  0:39
    :END:
#+BEGIN_SRC emacs-lisp
  ...
  ;; this is handled by cleanup-and-save-buffer
...
Take a look at [[https://github.com/hlissner/emacs-doom-themes][doom themes]]. And [[https://github.com/hlissner/emacs-solaire-mode][Solaire mode]].
...
**** TODO take a look at [[http://oremacs.com/worf/README.html][worf's manual]]
  ...
  (use-package org
    ...
    (use-package evil-org
      ...
      (with-eval-after-load 'org-src
        ...
        (define-key org-src-mode-map [remap cleanup-and-save-buffer]      'org-edit-src-save))
